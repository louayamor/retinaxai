...
from app.ocr.ocr_schema import ClinicalFindings, OCTReport, PatientInfo, RegionImage, ReportMetadata, RetinalThickness
from app.ocr.pipeline.ocr_pipeline import OCRPipeline
...
def test_ocr_pipeline_export_uses_configured_paths(monkeypatch, temp_input_dir, temp_output_dir, temp_images_dir):
    ...
    monkeypatch.setattr("app.ocr.pipeline.ocr_pipeline.pd.DataFrame.to_csv", fake_to_csv)
